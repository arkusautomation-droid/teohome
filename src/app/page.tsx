...
export default async function HomePage() {
  ...
  return (
    <>
      {/* ================================================================== */}
      {/* 1. HERO SECTION — with thumbnails on right                        */}
      {/* ================================================================== */}
      <section className="relative w-full overflow-hidden">
        <div className="flex flex-col lg:flex-row">
          {/* Main hero — left ~65% */}
          <div className="relative h-[500px] w-full lg:h-[620px] lg:w-[65%]">
            <img
            ...
            <div className="relative flex h-full items-center px-6 lg:px-12">
              <div className="max-w-xl">
                <h1 className="font-heading text-4xl leading-tight font-semibold text-white md:text-5xl lg:text-[56px] lg:leading-[1.1]">
                ...
                <Link
                  href="/kuchnie"
                  className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-medium text-text-primary transition-colors hover:bg-white/90"
                >
                  Zobacz więcej
          ...
          {/* Thumbnails — right ~35% */}
          <div className="hidden flex-col gap-2 lg:flex lg:w-[35%]">
      ...
      {/* ================================================================== */}
      {/* 2. BENEFITS BAR — right after hero                                */}
      {/* ================================================================== */}
      <section className="border-b border-border-light bg-bg-light py-5 lg:py-6">
          ...
          <div className="grid grid-cols-2 gap-5 md:grid-cols-4 md:gap-6">
            {categories.slice(0, 4).map((cat) => (
              <Link key={cat.id} href={`/kategoria/${cat.slug}`} className="group">
                <div className="aspect-square overflow-hidden rounded-xl bg-bg-light">
                  {cat.image?.src ? (
                    <Image
                      src={cat.image.src}
                ...
                <h3 className="mt-3.5 text-center text-sm font-medium text-text-primary md:text-base">
                  {cat.name}
                </h3>
              </Link>
            ))}
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
            <div className="lg:w-[55%]">
              <h2 className="font-heading text-2xl font-semibold text-text-primary md:text-3xl lg:text-[32px]">
                Witaj w TeoHome!
              </h2>
      ...
      {/* 5. DESIGNERS SECTION                                               */}
      {/* ================================================================== */}
      <section className="bg-bg-warm py-16 lg:py-20">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {designers.map((designer) => (
              ...
              >
                <div className="h-24 w-24 overflow-hidden rounded-full bg-bg-light">
                ...
                <Link
                  href="/kontakt"
                  className="mt-6 inline-flex items-center gap-2 rounded-full border border-text-primary px-6 py-2.5 text-sm font-medium text-text-primary transition-colors hover:bg-text-primary hover:text-white"
                >
                  Zamów projekt
                </Link>
              </div>
      ...
      <section className="py-16 lg:py-20">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <div className="flex flex-col gap-8 lg:flex-row">
            {/* Left - dark CTA */}
            <div className="relative flex flex-col justify-center overflow-hidden rounded-2xl bg-bg-dark px-8 py-12 lg:w-[340px] lg:shrink-0 lg:px-10 lg:py-16">
              <img
              ...
              <div className="relative z-10">
                <h2 className="font-heading text-2xl leading-snug font-semibold text-white md:text-3xl">
                  Nowe rozwiązania do Twojej przestrzeni
                </h2>
                <p className="mt-3 text-sm text-white/70">Rozpocznij podróż</p>
                <Link
                  href="/nowosci"
                  className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-medium text-text-primary transition-colors hover:bg-white/90"
                >
            ...
            {/* Right - product cards: grid on desktop, scroll on mobile */}
              ...
              <div className="grid grid-cols-2 gap-5 lg:grid-cols-4">
                {newProducts.slice(0, 4).map((product) => (
                  <Link
                    ...
                    className="group"
                  >
                    <div className="relative aspect-[4/5] overflow-hidden rounded-xl bg-bg-light">
                      <Image
                      ...
                      />
                      <span className="absolute left-3 top-3 rounded-md bg-badge-new px-3 py-1 text-xs font-semibold tracking-wide text-white uppercase">
                        Nowość
                      </span>
                    </div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center">
            <div className="lg:w-[40%]">
              <h2 className="font-heading text-2xl font-semibold text-white md:text-3xl lg:text-[32px]">
                Polecane produkty
              </h2>
            ...
            <div className="lg:w-[60%]">
              {bestsellerProduct ? (
                <div className="relative overflow-hidden rounded-2xl">
                  ...
                  />
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-6 lg:p-8">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                      <div>
                        <span className="inline-block rounded-md bg-badge-bestseller px-3 py-1 text-xs font-semibold tracking-wide text-white uppercase">
                          Bestseller
                        </span>
                        <h3 className="mt-3 text-lg font-semibold text-white">{bestsellerProduct.name}</h3>
                        <p className="mt-1 text-sm text-white/70 line-clamp-1">
                          {bestsellerProduct.short_description.replace(/<[^>]*>/g, "")}
                        </p>
                        <p className="mt-2 text-xl font-bold text-white">{formatPrice(bestsellerProduct.price)}</p>
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-medium text-text-primary transition-colors hover:bg-white/90"
                      >
                        Zobacz produkt
                        <ArrowRight size={15} strokeWidth={2} />
                      </Link>
                ...
                <div className="flex aspect-[16/10] items-center justify-center rounded-2xl bg-bg-light text-text-light">
      ...
      <section className="py-16 lg:py-20">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <h2 className="mb-10 font-heading text-2xl font-semibold text-text-primary md:text-3xl">
            Porady od TeoHome
          </h2>
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
            ...
            <Link href={blogPosts[0].href} className="group lg:w-1/2">
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-bg-light">
                <img
                  ...
                  className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent p-6 lg:p-8">
                  ...
                  <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-white transition-colors group-hover:text-primary-light">
                    Przejdź do artykułu
                    <ArrowRight size={14} strokeWidth={2} />
                  </span>
                </div>
            ...
            {/* Smaller posts */}
            <div className="grid flex-1 gap-5 sm:grid-cols-3 lg:grid-cols-1 lg:gap-4">
              {blogPosts.slice(1).map((post, i) => (
                <Link
                  key={i}
                  href={post.href}
                  className="group flex flex-col gap-3 sm:flex-col lg:flex-row lg:gap-5"
                >
                  <div className="aspect-[16/10] overflow-hidden rounded-xl bg-bg-light sm:aspect-[4/3] lg:aspect-[16/10] lg:w-[200px] lg:shrink-0">
                    <img
                      src={post.image}
                      alt={post.title}
                      className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {testimonials.map((t) => (
              <div key={t.name} className="rounded-2xl border border-border-light bg-white p-6 shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="h-11 w-11 overflow-hidden rounded-full bg-bg-light">
      ...
      <section className="py-16 lg:py-20">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <div className="flex flex-col gap-6 lg:flex-row">
            <div className="relative flex flex-col justify-center overflow-hidden rounded-2xl bg-bg-dark px-8 py-12 lg:w-[45%] lg:px-12 lg:py-16">
              <img
              ...
              />
              <div className="relative z-10">
                <h2 className="font-heading text-2xl leading-snug font-semibold text-white md:text-3xl lg:text-[32px]">
            ...
            <div className="grid flex-1 grid-cols-2 gap-4">
              {inspirationImages.map((img, i) => (
                <div key={i} className="aspect-square overflow-hidden rounded-xl bg-bg-light">
                  <img
                    src={img}
